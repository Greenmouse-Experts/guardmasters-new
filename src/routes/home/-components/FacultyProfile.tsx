...
const credentials = `PhD, MSc, MBA, CA, CFE, CFCS, CAMS, ChLPS, LPC, CPO, CPOI, CBRM, ABCP, CMgr, MCMI, MSyI, CPP
Lead Auditor & Lead Implementer – ISO 27001, 22301, 21502, 18788, 31000, 42001, 28000`;
      ...
      <div className="container mx-auto grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-16">
        ...
        <div className="lg:col-span-2 ">
          ...
          <div className="max-w-xl">
            <pre className="mt-4 text-base  text-accent/90  font-semibold max-w-xl whitespace-pre-wrap  md:text-lg font-pop">
              {credentials}
            </pre>
          </div>
            ...
            {stats.map((stat) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-0.5 leading-snug text-black/90">
                    {stat.label}
                  </div>
                </div>
              </div>
