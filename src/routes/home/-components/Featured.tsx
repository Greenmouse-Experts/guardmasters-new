    ...
    <section>
      ...
      <div className="bg-base-100 px-6 py-8 md:px-16">
        <div className="container mx-auto">
          <div className="mb-12">
            <h2 className="text-4xl leading-tight font-bold  md:text-4xl font-pop text-accent text-center uppercase">
              Training Programs and{" "}
              <span className="text-primary">Certification Courses</span>
            </h2>
          </div>
